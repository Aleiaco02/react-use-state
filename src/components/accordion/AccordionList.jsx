    ...
    return (
        <main>
            <div className="accordion-list">
                {languages.map((singolLanguage) => (



                    <AccordionCard
                        titolo={singolLanguage.title}
                        descrizione={singolLanguage.description}
                        isSelected={activeAccordion === singolLanguage.id}
                        onToggle={() => setActiveAccordion(singolLanguage.id)}
                        key={singolLanguage.id}
                    />
